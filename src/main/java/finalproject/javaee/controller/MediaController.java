...
import finalproject.javaee.dto.MediaUploadDTO;
...
public class MediaController extends BaseController {
    ...
    public void uploadImage(@RequestBody MediaUploadDTO dto, HttpSession session) throws Exception{ //TODO
        User user = (User)session.getAttribute("loggedUser");
        String base64 = dto.getMediaUrl();
